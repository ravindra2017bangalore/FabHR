...
public class DepartmentChartEmpMaster {
	...
	String caption, showBorder, use3DLighting, enableSmartLabels, startingAngle, showLabels, showPercentValues;
	String showLegend, numberPrefix,baseFontColor,formatnumberscale,thousandSeparatorPosition,baseFont,baseFontSize,centerLabelBold, showTooltip, decimals, useDataPlotColorForLabels, theme;
	
	
	
	  public DepartmentChartEmpMaster(String caption, String numberPrefix, String formatnumberscale, String showBorder,
